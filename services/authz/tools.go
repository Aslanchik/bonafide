...
// callers come online (testify in T-05, go-jose in T-06, chi+uuid in T-10,
// zitadel/oidc in T-11). Each blank import is removed when its real caller
// lands; the file vanishes once every dependency has a non-tooling import
// (no later than T-13).
package authz
